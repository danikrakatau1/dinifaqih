(()=>{
  ...
  async function hydrate(){
    ...
    try{
      ...
      frame.srcdoc=html;done=true;document.documentElement.dataset.templateEditAuthority='v1.16.6';
      if(dirty&&/DRAFT CLOUD LOADED/i.test(dirty.textContent||''))dirty.textContent=`DRAFT CLOUD LOADED ✓ · UUID ${recordId.slice(0,8)} · CANONICAL V1.16.6`;
