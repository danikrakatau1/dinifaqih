...
`function applyAll(){if(applying)return;applying=true;try{OPS.forEach(one);const root=document.documentElement;if(root&&root.getAttribute('data-dini-v3-delta-live')!=='1')root.setAttribute('data-dini-v3-delta-live','1')}finally{applying=false}}\n`+
