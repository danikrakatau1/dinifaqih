...
'use strict';
if(window.__DINI_SOURCE_AUTHORITY_RUNTIME_V110__)return;window.__DINI_SOURCE_AUTHORITY_RUNTIME_V110__=true;
const tpl=document.querySelector('template[data-dini-source-truth]');let G={};try{G=JSON.parse(tpl?.textContent||'{}')}catch{}
