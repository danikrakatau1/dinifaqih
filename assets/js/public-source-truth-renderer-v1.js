(()=>{
  ...
  function prepareHtml(pkg,row,guest){
    ...
    if(pkg.source_truth){
      ...
      if(galleryPerf.count)blocks.push('<script src="'+localAsset('/assets/js/gallery-performance-v1.js?v=140')+'"></script>');
    }else{
      if(pkg.authority){
    ...
    blocks.push('<script src="'+localAsset('/assets/js/rsvp-gift-feature-runtime-v1.js?v=130')+'"></script>');
