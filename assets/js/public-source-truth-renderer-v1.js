  ...
  function prepareHtml(pkg,row,guest){
    ...
    if(pkg.source_truth){
      ...
      if(galleryPerf.count){
        ...
        blocks.push('<script src="'+localAsset('/assets/js/gallery-section-transparent-v1.js?v=200')+'"></script>');
        blocks.push('<script src="'+localAsset('/assets/js/gallery-layer-debug-v1.js?v=100')+'"></script>');
      }
    }else{
      if(pkg.authority){
